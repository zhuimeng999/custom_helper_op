...
@tf.function
def sparse_conv3d_transpose_fast(images, filters, default_value, base_plane, data_format='NDHWC', strides=(1, 1, 1), dilations=(1, 1, 1), dynamic_default=False, name=None):
    with tf.name_scope(name or "sparse_conv3d_transpose_fast"):
        return _custom_helper_ops.sparse_conv3d_transpose_fast(images=images, filters=filters, default_value=default_value, base_plane=base_plane, 
                                                        data_format=data_format, strides=strides, dilations=dilations, dynamic_default=dynamic_default)
